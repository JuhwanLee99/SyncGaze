...
export const getFirebaseAdmin = () => {
  ...
  if (!app) {
    throw new Error(
      'Firebase admin is not configured. Ensure FIREBASE_STORAGE_BUCKET is set and credentials are provided via FIREBASE_PROJECT_ID/FIREBASE_CLIENT_EMAIL/FIREBASE_PRIVATE_KEY or FIREBASE_SERVICE_ACCOUNT_JSON.',
    );
  }
